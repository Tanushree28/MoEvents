...
function AdminDashboard() {
  ...
  const upcomingEvents = [
    { id: 1, title: 'Tech Conference', date: '2025-04-10', description: 'A conference on the latest tech trends.' },
      ...
      {showCreateEventForm && (
        <div className="create-event-form">
          ...
          <form onSubmit={handleCreateEvent}>
            ...
            <button type="button" onClick={() => setShowCreateEventForm(false)}>Cancel</button>
          </form>
        </div>
      )}
